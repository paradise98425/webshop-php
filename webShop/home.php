...
<html>
    ...
    <body>
            ...
            <div class="flex flex-col p-5">
                <!-- shopping cart icon begins-->
                <div class="flex items-end justify-end">
                    <li class="font-sans block mt-4 mr-6 lg:inline-block lg:mt-0 lg:ml-6 align-middle text-black hover:text-gray-700">
                ...
                <!-- shopping cart icon ends -->
                <div class="flex flex-col items-center justify-center p-10">  
                    <!-- content of the page begins -->
                    <img class="w-4/12" src="images/empty_cart.jpg" alt="Empty cart" />
                    <span class="mt-10">
                        <p class="text-xl">Your cart is empty. Make your shopping and fill your cart. &#128540;</p>
                    </span>
